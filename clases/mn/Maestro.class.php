<?php
	...
	class Maestro extends Tabla {
		...
		public static function getTipoVehiculo($referencia, $linea) {
			...
			if (strpos(strtolower($linea), "camion") !== false) return "pesados";
			if (strpos(strtolower($linea), "fvr") !== false) return "pesados";
			if (strpos(strtolower($linea), "b70 diesel") !== false) return "pesados";
			if (strpos(strtolower($linea), "kodiak 157") !== false) return "pesados";
			return "liviano";
		}
