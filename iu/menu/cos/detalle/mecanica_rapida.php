...
$descripcion = "Mecánica Rápida: " . (($tipo_vehiculo == "liviano") ? "LIVIANOS" : "PESADOS");
?>
    ...
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
        <thead>
            <tr class='ui-widget-header'>
                ...
                <td>Placa</td>
                <td>Tipo Vehiculo</td>
                <td>Mecanica Rapida</td>
                <td>Accesorios</td>
            </tr>
        </thead>
        <tbody>
            <?php
                foreach ($informe->getMecanicaRapidaData($tipo_vehiculo) as $data) {
                    ...
                    echo "<td>" . $data["mecanica_rapida"] . "</td>";
                    echo "<td>" . $data["accesorios"] . "</td>";
                    echo "</tr>";
                }
            ?>
        </tbody>
