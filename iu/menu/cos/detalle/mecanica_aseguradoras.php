...
$descripcion = "Aseguradoras: " . (($tipo_vehiculo == "liviano") ? "LIVIANOS" : "PESADOS");
?>
...
<div style='overflow-y: scroll; max-height: 400px;'>
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
        ...
        <tbody>
            <?php
            foreach ($informe->getMecanicaAseguradoraData($tipo_vehiculo) as $data) {
