...
$descripcion = "Mecánica Especializada: " . (($tipo_vehiculo == "liviano") ? "LIVIANOS" : "PESADOS");
?>
    ...
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
        <thead>
            <tr class='ui-widget-header'>
                ...
                <td>Placa</td>
                <td>Tipo Vehiculo</td>
                <td>Mecanica Especializada</td>
            </tr>
        </thead>
        <tbody>
            <?php
            foreach ($informe->getMecanicaEspecializadaData($tipo_vehiculo) as $data) {
                ...
                echo "<td>" . $data["mecanica_especializada"] . "</td>";
                echo "</tr>";
            }
            ?>
        </tbody>
