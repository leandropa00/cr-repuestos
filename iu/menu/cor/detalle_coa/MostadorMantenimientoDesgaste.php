<?php
    ...
    $descripcion = "Mostrador Mantenimiento / Desgaste: " . (($tipo_vehiculo == "liviano") ? "LIVIANOS" : "PESADOS");
?>
...
<div style='overflow-y: scroll; max-height: 400px;'>
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
		...
		<?php
            ...
            $total_SD = $total_CD = 0;
			foreach($informe->getMostadorMantenimientoDesgasteData($tipo_vehiculo, true) as $data) {
        ...
        <tfoot>
            <tr class='ui-widget-header'>
                <td colspan=11 style='text-align:right;'><b>Total SIN SUMAR DEVOLUCIONES</b></td>
                <td style='width:60px;text-align:right;'><b>$<?php echo Moneda::getMoneda($total_descuentos_SD, 0); ?></b></td>
                <td style='width:60px;text-align:right;'><b>$<?php echo Moneda::getMoneda($total_SD, 0); ?></b></td>
                <td style='width:60px;'></td>
            </tr>
            <tr>
                <td colspan=11 style='text-align:right;'><b>Totales SUMANDO DEVOLUCIONES</b></td>
                <td style='width:60px;text-align:right;'><b>$<?php echo Moneda::getMoneda($total_descuentos_CD, 0); ?></b></td>
