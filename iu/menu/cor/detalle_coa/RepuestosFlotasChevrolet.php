<?php
    ...
    $descripcion = "Repuestos Flotas Chevrolet: " . (($tipo_vehiculo == "liviano") ? "LIVIANOS" : "PESADOS");
?>
...
<div style='overflow-y: scroll; max-height: 400px;'>
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
		...
		<?php
            ...
            $total_SD = $total_CD = 0;
			foreach($informe->getRepuestosFlotasChevroletData($tipo_vehiculo, true) as $data) {
