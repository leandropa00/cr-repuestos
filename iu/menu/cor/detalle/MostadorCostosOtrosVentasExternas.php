<?php
    ...
    $descripcion = "Mostrador (Otros) / Ventas Externas: " . (($tipo_vehiculo == "liviano") ? "LIVIANOS" : "PESADOS");
?>
...
<div style='overflow-y: scroll; max-height: 400px;'>
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
		...
		<?php
            ...
            $total_SD = $total_CD = 0;
			foreach($informe->getCostoVentasExternasData($tipo_vehiculo) as $data) {
                //$margen = round((1 - ($data["totalc"] / $data["totalc"])) * 100, 0);
                $class = "";
