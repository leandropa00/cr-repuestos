<?php
    ...
    $descripcion = "Repuestos Flotas Otras Marcas";
    ...
    $chevrolet = isset($_GET["chevrolet"]);
    $documentos = $chevrolet ? array('FS','FSC', 'NDSR', 'NCSR') : array('FA','FRD','FL','FT','FC', 'NCDR', 'FG', 'FPC');
...
<div style='overflow-y: scroll; max-height: 400px;'>
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
		...
		<?php
            ...
            $total_SD = $total_CD = 0;
			foreach($informe->getCostoRepuestosFlotasOtrasMarcasData($tipo_vehiculo, false, $chevrolet) as $data) {
                ...
                echo "<td style='text-align:right;'>$" . Moneda::getMoneda($data["total"],0) . "</td>";
		...
		?>
            ...
            <tr class='error'>
                <td colspan=13 style='text-align:right;'><b>Devoluciones del mes actual:</b></td>
                <td style='width:60px;text-align:right;'><b>$<?php echo Moneda::getMoneda($total_SD - $total_CD, 0); ?></b></td>
                <td style='width:60px;'></td>
            </tr>
            <tr class='error'>
                <td colspan=15 style='text-align:center;'><h3>DEVOLUCIONES DE OTROS MESES</h3></td>
            </tr>
            <?php
                $total_descuentos_SD = $total_descuentos_CD = 0;
                ...
                $r = BD::sql_query("select v.*, c.nombre cliente_nombre 
                    ...
                    WHERE 
                        ...
                        AND concat(v.tipo, v.numero) in (
                            ...
                            AND d.tipo_link in ('" . implode("','", $documentos). "') and d.informe_id=" . $informe->id . "
                        )") 
        ...
        <tfoot>
            <tr class='ui-widget-header'>
                <td colspan=13 style='text-align:right;'><b>TOTAL - DEVOLUCIONES:</b></td>
