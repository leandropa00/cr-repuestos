<?php
    ...
    $descripcion = "Costo de venta Taller";
    ...
    $documentos = $chevrolet ? array('NDSR', 'NCSR', 'FSC') : array('FC', 'FT', 'NCDR', 'FPC', 'EXAJ');
    $tipo_proveedor = 'gm';
?>
...
<div style='overflow-y: scroll; max-height: 400px;'>
    <table class="table table-condensed table-hover table-bordered" style='font-size:12px;'>
		...
		<?php
            ...
            $total_SD = $total_CD = 0;
			foreach($informe->getVentasTallerData($tipo_vehiculo, false, $chevrolet) as $data) {
