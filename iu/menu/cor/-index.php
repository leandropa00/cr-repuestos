...
<!--- PESADOS --->
			...
			<tr>
				<td style='padding-left:20px;'>Costo de venta Garantías</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasGarantias.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasGarantias('pesados', false, true), 0) ?></a></td>
