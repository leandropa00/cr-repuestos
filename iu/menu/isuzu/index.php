	...
	<table class='table table-bordered table-condensed table-hover' style='margin-top:10px;width:440px;'>
		<thead>
			<tr class='ui-widget-header' style='font-size:18px;'>
				<th colspan=2 style="text-align:center;">COR ISUZU - <?php echo $informe->getPeriodo()->format("F/Y"); ?></th>
			</tr>
		</thead>
		<tbody>
<!--- PESADOS --->
			<tr><td class='tr_titulo' colspan=2>RESUMEN VENTAS DETAL TOTAL</td></tr>
			<tr>
				<td style='font-weight:bold;width:290px;'><b>Mostrador</b></td>
			...
			<tr>
				...
				<td style="text-align:right;font-weight:bold;">$<?php echo Moneda::getMoneda($informe->getTotalCostosVenta('pesados'), 0) ?></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Costo de venta Mostrador</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasMostrador.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasMostrador('pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Costo de venta Taller</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasTaller.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasTaller('pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Costo de venta Colisión</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasColision.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasColision('pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Costo de venta Garantías</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasGarantias.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasGarantias('pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Costo de venta Internos</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasInternos.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasInternos('pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Costo de venta Alternos</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/VentasAlternos.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getVentasAlternos('pesados'), 0) ?></a></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/ComprasRepuestosGM.php?tipo=CRCO&tipov=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getTotalComprasRepuestos(array('CRCO'), 'pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Compras repuestos a otros concesionarios</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/ComprasRepuestosGM.php?tipo=CRO&tipov=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getTotalComprasRepuestos(array('CRO'), 'pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Compras repuestos a otros proveedores</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/ComprasRepuestosGM.php?tipo=CROT&tipov=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getTotalComprasRepuestos(array('CROT'), 'pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='font-weight:bold;'>Inventarios</td>
				<td style="text-align:right;font-weight:bold;">$<?php echo Moneda::getMoneda($informe->getTotalInventarios('pesados'), 0) ?></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Entregado a Servicio</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/InventariosEntregadoAServicio.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getInventariosEntregadoAServicio('pesados'), 0) ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Inventario 0 a 12 meses</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/InventarioEdad.php?edad=0M-12M&tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getInventarios('0M-12M', 'pesados'), 0); ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Inventario 12 a 24 meses</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/InventarioEdad.php?edad=12M-24M&tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getInventarios('12M-24M', 'pesados'), 0); ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Inventario 24 o más meses</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/InventarioEdad.php?edad=24M-MAS&tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getInventarios('24M-MAS', 'pesados'), 0); ?></a></td>
			</tr>
			<tr>
				<td style='padding-left:20px;'>Inventario Alternos</td>
				<td style="text-align:right;"><a onclick="verVentana('#ventana', 'detalle/InventariosAlternos.php?tipo=pesados');" href='#'>$<?php echo Moneda::getMoneda($informe->getInventariosAlternos('pesados'), 0); ?></a></td>
			</tr>
			<tr>
...
<script>
	...
	function verVentana(div, script) {
		showMessage();
		$(div).load("<?php echo DIR_WEB; ?>../cor/" + script);
	}

	function descargarVentasPorAsesor() {
		showMessage();
		var periodo = $("#seleccion_periodo").val();
		document.location.href='<?php echo DIR_WEB; ?>../cor/ventasxasesor.php?periodo=' + periodo;
		setTimeout(function () {
	...
	function descargarUbicacionRepuestos() {
		showMessage();
		var periodo = $("#seleccion_periodo").val();
		document.location.href='<?php echo DIR_WEB; ?>../cor/ubicacion_repuestos.php?periodo=' + periodo;
		setTimeout(function () {
			$.post("index.php", { sync : "true"}, function(r) { hideMessage(); })
		}, 5000);
	}
