...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        //
        gridcontainer.css("overflow-y", "visible").height(option.height + 70);
        ...
        function getTitle(event) {
            ...
            locationshow = (event[1] != undefined && event[1] != "") ? event[1] : i18n.xgcalendar.i_undefined;
            ...
            //ret.push("FECHA: ", timeshow + ". \n", $.browser.mozilla ? "":". \n", "ASUNTO: ", eventshow,$.browser.mozilla ? ".\n " : "\r\n", i18n.xgcalendar.location + ":", locationshow + "");
            ret.push(
            	"RESPONSABLE: ", event[12] + ". \n", 
            	"FECHA: ", timeshow + ". \n", 
            	"MOTIVO: ", locationshow + ".");
            return ret.join("");
        }
        ...
        function tc(d) {
            function zc(c, i) {
                var d = "";
        ...
        function dayshow(e, data) {
			...
			showMessage();
			if (RUTA_AGENDA != "") {
				$("#ventana").load(RUTA_AGENDA + "ver.php", { id : data[0] }, function() {
					$("#mensajes").hide();
				});
				return;
			}
            if (data[11] == "1") {
            	//En este caso es una prueba de poligrafía
				$("#ventana").load("iu/5/agenda/ver.php", { id : data[0] }, function() {
					$("#mensajes").hide();
				});
			}
			if (data[11] == "0") {
				//Este caso es cuando se realizan visitas a clientes por parte de los comerciales o jefes de operaciones.
				$("#ventana").load("iu/4/agenda_comercial/ver.php", { id : data[0] }, function() {
					$("#mensajes").hide();
				});
			}
			return;
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div><br />'
						+ '<b>Estado</b>: <select id="estado_tarea">'
						+ '<option value="1">Registrado</option>'
						+ '<option value="2">Realizado</option>'
						+ '<option value="3">Cancelado Cliente</option>'
						+ '<option value="4">Cancelado Usuario</option>'
						+ '</select>'
						+ '</td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>'
					...
					$("#estado_tarea").attr("disabled", "disabled").unbind('change').bind('change', function(){
						cambioEstadoTarea(data[0], $(this).val());
					});
					$("#estado_tarea").val(data[10]);
					if (data[10] != "1")
						$("#estado_tarea").attr("disabled", "disabled");
					else
						$("#estado_tarea").removeAttr("disabled");
                    if (pos.hide) {
                        $("#prong1").hide();
                    }
                    else {
        ...
        function quickadd(start, end, isallday, pos) {
            if ((!option.quickAddHandler && option.quickAddUrl == "") || option.readonly) {
                /*
                 * Nueva ventana para ingresar los datos que se desean agendar
                 * */
				var fInicio = dateFormat.call(start, "yyyy-MM-dd HH:mm");
				var fFin = dateFormat.call(end, "yyyy-MM-dd HH:mm");
				showMessage();
				if (RUTA_AGENDA != "")
					$("#ventana").load(RUTA_AGENDA + "nuevo.php", { ini : fInicio, fin : fFin} );
				/*else $("#ventana").load("iu/4/agenda_comercial/nuevo.php", { ini : fInicio, fin : fFin} );*/
				return false;
            }
        ...
        function ResizeView() {
            ...
            if (_viewType == "day" || _viewType == "week") {
                ...
                var calH = option.height + 73 - dvwkH;
                $dvtec.height(calH);
