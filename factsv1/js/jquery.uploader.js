...
qq.FileUploader = function(o){
    this._options = {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area ui-corner-all"><span>Arrastre archivos<br />a esta zona</span></div>' +
                '<div class="qq-upload-button ui-corner-all">Seleccionar archivo</div>' +
                '<ul class="qq-upload-list" style="list-style:none; margin:0px; padding-left:5px;"></ul>' + 
             '</div>',
        ...
        messages: {
            ...
            typeError: "El archivo <b>{file}</b> tiene una extensión inválida.<br />Extensiones permitidas: <b>{extensions}</b>.",
            sizeError: "El archivo <b>{file}</b> excede el tamaño permitido.<br />Tamaño máximo por archivo: <b>{sizeLimit}</b>.",
            emptyError: "{file} está vacío, Seleccione otro archivo."            
        },
        showMessage: function(message){
            jAlert(message, "Información");
        }
    };
